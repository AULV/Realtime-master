...
<script src="<c:url value="/resources/js/angularjs/angular.gn.min.js"/>"></script>
...
<body ng-controller="MainCtrl" style="font-family: Calibri,Candara,Segoe,Segoe UI,Optima,Arial,sans-serif;">
...
<div class="tabla" id="informacionTabla" style="display: none;">
	...
	<table class="row" style="width: 100%">
		...
		<tr align="center">
			...
			<td width="400px">
				<div class="col-md-3" style="width: 100%" style="background-color: transparent;">
